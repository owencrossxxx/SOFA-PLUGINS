...
#include "../../../src/applications/sofa/gui/qt/AddObject.h"
...
void sofa::gui::qt::AddObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddObject *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AddObject::*)(std::string , double , double , double , double , double , double , double );
...
QT_INIT_METAOBJECT const QMetaObject sofa::gui::qt::AddObject::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_sofa__gui__qt__AddObject.data,
    qt_meta_data_sofa__gui__qt__AddObject,
    qt_static_metacall,
    nullptr,
    nullptr
} };
