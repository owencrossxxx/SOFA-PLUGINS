...
#include "../../../../src/applications/sofa/gui/qt/panels/QDocBrowser.h"
...
void sofa::gui::qt::DocBrowser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DocBrowser *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject sofa::gui::qt::DocBrowser::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_sofa__gui__qt__DocBrowser.data,
    qt_meta_data_sofa__gui__qt__DocBrowser,
    qt_static_metacall,
    nullptr,
    nullptr
} };
